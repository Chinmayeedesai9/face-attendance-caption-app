...
path = r'C:\Users\Lenovo\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Students'
images = []
classNames = []
...
def markAttendance(name):
    ...
    with open(file_path, 'r+') as f:
        ...
        # Append name and timestamp if not already present
        ...
        if name != 'UNKNOWN':
            ...
            if name in recognition_times:
                if now - recognition_times[name] >= timedelta(seconds=3):
                    markAttendance(name)
                    recognition_times[name] = now  # Update recognition time
            else:
                recognition_times[name] = now  # First-time recognition
                markAttendance(name)
